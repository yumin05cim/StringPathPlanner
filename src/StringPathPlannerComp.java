// -*- Java -*-
/*!
 * @file StringPathPlannerComp.java
...
/*!
 * @class StringPathPlannerComp
 * @brief Standalone component Class
 *
 */
public class StringPathPlannerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(StringPathPlanner.component_conf);
      mgr.registerFactory(prop, new StringPathPlanner(), new StringPathPlanner());

      // Create a component
      RTObject_impl comp = mgr.createComponent("StringPathPlanner");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        StringPathPlannerComp init = new StringPathPlannerComp();
